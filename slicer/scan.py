...
for i in [4, 5, 6, 7, 8]:
    jobname = '{}_{}_{}'.format(data_sample, prefix, i)
    ...
    with open('../job/{}'.format(fcl_filename), 'w') as f_fcl:
        ...
        # f_fcl.write('physics.producers.slicermergeviews.Tolerance: 10')
        f_fcl.write('physics.producers.slicermergeviews.fd.Tolerance: 15')
