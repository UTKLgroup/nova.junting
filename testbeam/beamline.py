...
class Beamline:
    ...
    def write(self):
        ...
        self.f_out.write('beam gaussian particle=$particle firstEvent=$first lastEvent=$last sigmaX=2.0 sigmaY=2.0 beamZ=-500.0 beamY=-10.5 rotation=x-1.2 meanMomentum=$momentum\n')
