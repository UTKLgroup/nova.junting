...
ifdh cp /pnfs/nova/persistent/users/dphan/novatestbeam/bl2nd_simulation/input_092619/secondary.in ./secondary.in

g4bl secondary.in first=${FIRST} last=${LAST}

chmod 766 g4beamline.root
ifdh cp g4beamline.root /pnfs/nova/persistent/users/dphan/novatestbeam/bl2nd_simulation/output_092619/g4beamline.${FIRST}.root
